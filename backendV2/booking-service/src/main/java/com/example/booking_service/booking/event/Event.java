...
public class Event {
    ...
    @Column(name = "organizer_display_name", nullable = false)
    ...
    public Integer getCancellationCutoffHours() {
        return cancellationCutoffHours;
    }

    public void setCancellationCutoffHours(Integer cancellationCutoffHours) {
